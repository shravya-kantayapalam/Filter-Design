...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p1.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{fig/p1.png}
    \caption{The Analog Low-Pass Frequency Response for $0.169  \leq \epsilon \leq 0.61$}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/skgen.c
\end{lstlisting}
The poles obtained are formulated in the table below.
\input{tables/table1.tex}
The below code plots the pole-zero plot.
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
...
\end{align}
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p3.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p4.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
\end{align}
 \begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p5.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
\end{align}
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p6.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
\end{enumerate}
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p7.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
...
\end{align}
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Filter-Design/blob/main/Filter%20Design/codes/p8.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
